...
namespace Bl
{
    public class AppointmentBl
    {
        ...
        public bool AddAppointment(int customerId, DateOnly date, Treatment treatment)
        {
        ...
        public bool UpdateAppointment(int customerId, DateOnly date, Treatment treatment)
        {
            var appt = _appointmentService.GetAppointmentByDate(date);
            if (appt == null)
            {
