...
namespace Dal.Services
{
    public class AppointmentService:IAppointement
    {
        ...
        //פונקציה שמחפשת לקוח לפי הID שלו ומחזירה אותו
        ...
        //כאן צריך לבדוק לפי תאריך חסום או אם קבעו שם תור כבר

        //פונקציה שבודקת האם התאריך תפוס על ידי לקוח אחר
        public bool IsDateTaken(DateOnly date)
        {
            //ממיר לdateonly במקום datetime
            return _dbContext.Appointments.Any(a => a.ScheduledTime == date);


        }

        //public List<DateOnly> GetBlockedDates()
        //{
